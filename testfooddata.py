import unittest
from fooddata import typeOfLine, singlelineToDict, seriousRowDecoder , relativeRisk, violationsToList  , additonalViolations , makeChart, inspectionResults, restaurantsTypes , commonViolationsChart
...
class fooddataTestCase(unittest.TestCase):
    ...
    def test_mostcommmonV(self):
        testCase = dict()
        testCase["control chart title"] = 'CommonViolations.htm'
        testCase["control chart options"] = """
        var options = {
        ...
        self.assertTrue( not commonViolationsChart(testCase))  
    
    def test_relativeRisk(self):
        """Does the test case return true when expected"""
        expectedResult = False #expected result for good data
        testCase = dict()
        testCase["control open chart"] = False # control to open the chart in a web browser
        testCase["control chart title"] = 'inspectionResultsTest.htm'
        testCase["control chart options"] = """
        var options = {
          title: 'Inspection Results',
